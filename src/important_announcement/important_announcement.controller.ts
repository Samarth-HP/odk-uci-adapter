...
@Controller('important-announcement')
export class ImportantAnnouncementController {
  constructor(@InjectQueue('important-announcement') private readonly submissionQueue: Queue) {
  }
